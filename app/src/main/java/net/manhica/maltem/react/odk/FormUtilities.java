...
import net.manhica.maltem.react.odk.listener.OdkFormLoadListener;
import net.manhica.maltem.react.odk.model.FilledForm;
import net.manhica.maltem.react.odk.task.OdkGeneratedFormLoadTask;
...
public class FormUtilities {
    ...
    private void createXFormNotFoundDialog() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mContext);
          alertDialogBuilder.setTitle(mContext.getString(R.string.label_odk_warning));
          alertDialogBuilder.setMessage(mContext.getString(R.string.label_odk_unfinished_form));
